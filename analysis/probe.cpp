...
int main(int argc, char** argv){
    initZ(); initGeom();
    Pos P0; P0.b.fill(0);
    P0.b[0]=6; P0.b[1]=3; P0.b[2]=2; P0.b[3]=4;      // K B N R on a1..d1
    P0.b[7]=1;                                        // white pawn d2
    P0.b[16]=14; P0.b[17]=11; P0.b[18]=10; P0.b[19]=12; // black k b n r on a5..d5
    P0.b[15]=9;                                       // black pawn d4 -> idx 12+3=15
    P0.wtm=1; P0.castl=3;
